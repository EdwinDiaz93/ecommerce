...
export const LoginForm = () => {
    ...
    return (
        <div className="bg-white text-gray-500 w-120 h-100 mx-4 md:p-6 p-4 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10 flex flex-col items-center">
            <h2 className="text-2xl font-semibold mb-6 flex flex-col items-center justify-center text-gray-800">
                ...
                <span className='text-2xl'>Clothing store
                </span>
            </h2>
            <form autoComplete='off' onSubmit={handleSubmit(onSubmit)} className='flex flex-col w-full'>
                ...
                />
                <span className='text-red-600 font-light text-center w-full mb-3'>{errors.email?.message}</span>
